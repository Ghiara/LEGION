...
class AttentionBasedExperts(MixtureOfExperts):
    def __init__(
        ...
        self.should_use_task_encoding = task_encoder_cfg.should_use_task_encoding # CARE True
        ...
        if not self.should_use_task_encoding:
            ...
            embedding_dim = multitask_cfg.task_encoder_cfg.model_cfg.embedding_dim # 50
    ...
    def forward(self, task_info: TaskInfo) -> TensorType:
        ...
        output = self.trunk(emb) # dim=num_experts
