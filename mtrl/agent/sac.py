...
class Agent(AbstractAgent):
    ...
    def __init__(
        ...
        device: torch.device,
        actor_cfg: ConfigType, # metaworld_actor.yaml
        critic_cfg: ConfigType, # metaworld_critic.yaml
        alpha_optimizer_cfg: ConfigType,
        actor_optimizer_cfg: ConfigType,
        critic_optimizer_cfg: ConfigType,
        multitask_cfg: ConfigType, # metaworld_multitask.yaml
        discount: float,
        ...
        self.should_use_task_encoder = self.multitask_cfg.should_use_task_encoder # CARE, True
        ...
        ###############################################################
        ############ Mixture of Encoding include in Actor #############
        ###############################################################
        # see metaworld_actor.yaml & metaworld_encoder.yaml --> type_to_select=moe
